...
import Testing
import UIKit
@testable import RichMarkdownBlockEditor

/// demo `RichMarkdownThemePreset`과 같은 규격의 테마 fixture.
/// MarkdownStyler가 preset이 아니라 `RichMarkdownTheme`만 받는 계약을 검증한다.
private extension RichMarkdownTheme {
    static let testLarge = RichMarkdownTheme(
    ...
    static let testSerif = RichMarkdownTheme(
    ...
    static let testTinted = RichMarkdownTheme(
